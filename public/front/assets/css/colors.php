...
// CSS olarak çıktı veriyoruz
header("Content-Type: text/css");
use App\Models\Setting;

$settings = Setting::all()->pluck('value', 'key');

$navbarColor = $settings['navbar_color'] ?? '#1e3c72';
$sidebarColor = $settings['sidebar_color'] ?? '#2a5298';
$buttonColor = $settings['button_color'] ?? '#f7e5f';
...
/* Dinamik olarak PHP tarafından üretilen CSS değişkenleri */
<style>
:root {
...
/* Nav Menu Colors */
--nav-color: <?php echo $navbarColor; ?>;  /* Navbar ana rengi */
--nav-hover-color: <?php echo $accentColor; ?>; /* Navbar hover rengi */
--nav-mobile-background-color: <?php echo $backgroundColor; ?>; /* Mobil menü arka plan rengi */
--nav-dropdown-background-color: <?php echo $surfaceColor; ?>; /* Dropdown menü arka plan rengi */
--nav-dropdown-color: <?php echo $navbarColor; ?>; /* Dropdown menü link rengi */
--nav-dropdown-hover-color: <?php echo $accentColor; ?>; /* Dropdown menü hover rengi */
}
...
*/
    ...
    .trainers-index .member_container{
        position: relative;
        margin-top: -100px;
        z-index: 99;
    }
    .trainers-index .member_container .member_row{
        justify-content: center;
        gap: 100px;
    }
    ...
    .game-section .item:after {
        ...
        left: 0;
        top: 0;
        background-image: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.54));
    }
